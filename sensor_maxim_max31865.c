...
static rt_ssize_t _max31865_polling_get_data(rt_sensor_t sensor, struct rt_sensor_data *data)
{
    float temperature;
...
static rt_ssize_t max31865_fetch_data(struct rt_sensor_device *sensor, void *buf, rt_size_t len)
{
    RT_ASSERT(buf);
